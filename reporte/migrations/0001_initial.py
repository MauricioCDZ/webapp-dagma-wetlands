# Generated by Django 3.1.7 on 2021-04-15 08:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200)),
                ('foto', models.ImageField(upload_to='reporte/static/reporte/img/faunaAcuatica/', verbose_name='Image')),
                ('dateCreated', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200)),
                ('foto', models.ImageField(upload_to='reporte/static/reporte/img/faunaTerrestre/', verbose_name='Image')),
                ('dateCreated', models.DateTimeField(auto_now_add=True)),
                ('familia', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reporte.familiafauna')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=200)),
                ('foto', models.ImageField(upload_to='reporte/static/reporte/img/flora/', verbose_name='Image')),
                ('dateCreated', models.DateTimeField(auto_now_add=True)),
